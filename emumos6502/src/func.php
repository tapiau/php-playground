...
define('__MAGENTO',realpath(__ROOT.'/../..'));
define('__TMP',realpath(__MAGENTO.'/var/tmp/'));
//define('__TMP','/tmp/');
...
//	if (!$ob) {
//		$dbg = debug_backtrace();
//		echo "<pre style='background-color: #efefef; border: 1px solid #aaaaaa; text-align: left;'>";
//		echo "<div style='font-weight: bold; background-color: #FFF15F; border-bottom: 1px solid #aaaaaa;'>\n    {$dbg[0]['file']}:{$dbg[0]['line']}\n</div>\n";
//		print_r($tab);
//		echo "\n</pre>\n";
//	} else {
//		ob_start();
